...
2. 2. **Анализ корреляций:** Настроена корректная визуализация матрицы Пирсона (`vmin=-1, vmax=1`). Выявлена умеренная прямая связь между стоимостью квадратного метра и годом постройки дома.
